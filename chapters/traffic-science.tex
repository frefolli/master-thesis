...
\putimagecouple
{\putsubimage{figures/multigraph-is-better-than-nothing.png}{A complex intersection pair which is connected with more different roads (Viale Zara. Milan. Italy). In \textit{green} the main lanes, in \textit{blue} the side lanes, in \textit{orange} the tramway. Source: Google Maps (2025)}{fig:multigraph-is-better-than-nothing}{0.45}{1.0}}
{\putsubimage{figures/atlanta-georgia-freeway.jpg}{A view of Atlanta Freeway, Georgia. Source: \href{https://www.cnu.org/publicsquare/2017/08/03/why-urban-freeway-expansion-futile}{cnu.org}}{fig:atlanta-georgia-freeway}{0.45}{1.0}}

\putimagecouple
{\putsubimage{figures/bologna-bypass.jpg}{Highlight of alternatives for the Bologna node bypass. Source: Corriere della Sera}{fig:bologna-bypass}{0.45}{1.0}}
{\putsubimage{figures/houston-interchange-siena.png}{Comparison between a cloverleaf in Houston, USA, and the city center of Siena, Italy. Source: \href{https://www.reddit.com/r/geography/comments/193ryy5/siena_compared_to_highway_interchange_in_houston/}{r/geography}}{fig:houston-interchange-siena}{0.45}{1.0}}

\putimagecouple
{\putsubimage{figures/ODZones.Show.Milano2010.png}{OD Zones used within the 2010 Milan AMAT model.}{fig:odzones-milano-2010}{0.45}{1.0}}
{\putsubimage{figures/city-slice-of-a-whole.png}{The setting of simulation scenarios is a slice of a highly connected city.}{fig:city-slice-of-a-whole}{0.45}{1.0}}

\putimagecouple
{\putsubimage{figures/ODGraph.Mean.Lombardia2014.png}{Traffic levels from OD Matrix of Lombardy in 2014.}{fig:odmatrix-lombardy-2014}{0.45}{1.0}}
{\putsubimage{figures/ODGraph.Mean.Milano2010.png}{Traffic levels from OD Matrix of Milan in 2010.}{fig:odmatrix-milano-2010}{0.45}{1.0}}

\putimagecouple
{\putsubimage{figures/setting-celoria.png}{The setting "One" with five intersections.}{fig:setting-celoria}{0.45}{1.0}}
{\putsubimage{figures/setting-breda.png}{The setting "One" with two intersections.}{fig:setting-breda}{0.45}{1.0}}
