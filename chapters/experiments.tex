...
Now that there is a clearer picture of the potential of the main reinforcement learning algorithms implemented in SUMO-RL, we need to understand if they stand a chance with fixed cycle traffic light programs.
...
\putimage{figures/exp/exp-4-fca.png}{Comparison of Fixed15, Fixed30, Fixed45 and Fixed60 agents.}{fig:exp-4-fca}{1.0}
...
\putimage{figures/exp/exp-4-tot.png}{Comparison of Fixed15, PPO and DQL agents and priority based intersections.}{fig:exp-4-tot}{1.0}
