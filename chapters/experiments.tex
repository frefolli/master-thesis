...
\putimage{figures/exp/cdd-leads-to-lower-awt.png}{The "Curriculum Daily + Disruption" dataset leads to lower average accumulated waiting times.}{fig:cdd-leads-to-lower-awt}{0.75}
\putimage{figures/exp/cdd-leads-to-lower-wt.png}{The "Curriculum Daily + Disruption" dataset leads to lower average waiting times.}{fig:cdd-leads-to-lower-wt}{0.75}
\putimage{figures/exp/cdd-leads-to-lower-as.png}{The "Curriculum Daily + Disruption" dataset leads to lower average speed.}{fig:cdd-leads-to-lower-as}{0.75}
\putimage{figures/exp/cdd-leads-to-higher-ar.png}{The "Curriculum Daily + Disruption" dataset leads to higher average arrival rate.}{fig:cdd-leads-to-higher-ar}{0.75}
\putimage{figures/exp/cdd-leads-to-higher-dr.png}{The "Curriculum Daily + Disruption" dataset leads to higher average departure rate.}{fig:cdd-leads-to-higher-dr}{0.75}
